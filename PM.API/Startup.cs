...
namespace PM.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.Configure<IWebConfiguration>(Configuration.GetSection("ConnectionStrings"));
            services.AddSingleton<IUserDetailsDbManager, UserDetailsDbManager>(serviceProvider =>
            {
